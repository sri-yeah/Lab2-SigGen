...
void Vrom2___024root__trace_chg_sub_0(Vrom2___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vrom2___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrom2___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vrom2___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vrom2___024root__trace_chg_sub_0(Vrom2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vrom2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrom2___024root__trace_chg_sub_0\n"); );
    // Init
...
void Vrom2___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrom2___024root__trace_cleanup\n"); );
    // Init
    Vrom2___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vrom2___024root*>(voidSelf);
    Vrom2__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
