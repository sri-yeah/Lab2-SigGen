...
VL_INLINE_OPT void Vcounter___024root___nba_sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__count1;
    __Vdly__count1 = 0;
    // Body
    __Vdly__count1 = vlSelf->count1;
    if (vlSelf->rst) {
        __Vdly__count1 = 0U;
        vlSelf->count2 = 0U;
    } else if (vlSelf->en) {
        __Vdly__count1 = (0xffU & ((IData)(1U) + (IData)(vlSelf->count1)));
        vlSelf->count2 = (0xffU & ((IData)(vlSelf->count1) 
                                   + (IData)(vlSelf->offset)));
    }
    vlSelf->count1 = __Vdly__count1;
}
